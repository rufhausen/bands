...
class AlbumController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('albums.create', compact('bands', 'genres', 'formAction'));
    }
    ...
    public function edit(Album $album)
    {
        $bands      = Band::all();
        $genres     = Genre::all();
        $formAction = route('albums.update', ['id' => $album->id]);

        return view('albums.edit', compact('album', 'bands', 'genres', 'formAction'));
    }
