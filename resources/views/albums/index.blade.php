        ...
        <div style="margin-top: 20px;">
            @if(\Request::exists('band_id'))
                <div class="col-md-1 pull-right">
                    <a href="{{ route('albums.index') }}" class="btn btn-default"><i class="fa fa-refresh" aria-hidden="true"></i>Reset</a>
                </div>
            @endif
            ...
            <table class="table table-striped"  data-toggle="dataTable" data-form="deleteForm">
                <thead>
                    <tr>
                        <th></th>
                        <th>
                            <a href="?sort_column=name&order={{ $sortParams['order'] }}">Album <small class="text-muted">(Genre)</small></a>
                    ...
                    @foreach($albums as $album)
                        <tr>
                            ...
                            <th scope="row">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="{{ route('albums.edit', ['id' => $album->id]) }}" class="btn btn-primary btn-sm">
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-2 pull-left">
                                        ...
                                        <img width="80px;" src="{{ $album->cover_image_path }}" class="img-rounded img-responsive"/>
                                    @else
                                        <image width="80px;" src="https://unsplash.it/100" class="img-rounded img-responsive"/>
                                    @endif
                                    </div>
