...
@endif
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input class="form-control" name="name" id="albumName" type="text" value="{{ old('name', isset($album->name) ? $album->name : null) }}" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="input-group date" id="recordDate">
                    <input class="form-control" name="record_date" type="text" id="record_date_input" value="{{ old('record_date', isset($album->record_date) ? $album->record_date : null) }}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="input-group date" id="releaseDate">
                    <input class="form-control" name="release_date" type="text" id="release_date_input" value="{{ old('release_date', isset($album->release_date) ? $album->release_date : null) }}"/>
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar">
                        </span>
                    </span>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input class="form-control" name="label" id="labelName" type="text" value="{{ old('label', isset($album->label) ? $album->label : null) }}" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input class="form-control" name="producer" id="producerName" type="text" value="{{ old('producer', isset($album->producer) ? $album->producer : null) }}" />
            </div>
        </div>
