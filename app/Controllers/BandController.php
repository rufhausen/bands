...
class BandController extends Controller
{
    ...
    {
        $formAction = route('bands.store');

        return view('bands.create')->with('formAction', $formAction);
    }
    ...
    {
        $formAction = route('bands.update', $band->id);

        return view('bands.edit', ['band' => $band])->with('formAction', $formAction);
    }
